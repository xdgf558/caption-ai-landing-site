...
- `src/generated/novelPaymentConfig.js` 和 `src/generated/protectedSerialContent.js` 都保留在 repo 中，方便 Worker import 和本地开发直接启动
- 文件头部带 `Generated by ... / Do not edit this file by hand`
- 修改小说 Markdown 或收费字段后，应运行 `npm run build` 或 `npm run build:novel-payment-config` 刷新生成文件
- 不把 `src/generated/` 加入 `.gitignore`，避免新环境缺少 Worker import 依赖
...
5. 隐藏门禁，展示章节正文
6. 正文容器使用轻量 fade-in，减少弱网加载完成时的突兀切换
