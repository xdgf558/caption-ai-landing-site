...
最新状态（2026-09-09）：下方所有 G1–G4 及行号均为 M0 历史基线。原会员 #118 的原子幂等/UTC/回跳修复、#119 的人工退款审核均已上线；用户报告真实兑换和人工撤销验收完成。音乐 M1-01/02 只交付数据与策略，真实只读资格适配仍待 M1-03；不得把历史缺陷当成当前未修，也不得把用户报告扩大为代理的 Safari/并发实测。
