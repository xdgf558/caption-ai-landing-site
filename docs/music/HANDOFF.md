...
#146/#147/#148 已按用户授权合并，基线 main@9e51b4c。当前分支 codex/music-album-management 实现专辑模型与管理，合同和预发顺序见 [M5_ALBUM_MANAGEMENT](M5_ALBUM_MANAGEMENT.md)。包含 0007 本地迁移、已有集合 API 扩展、专辑/歌单后台、曲序与成员封面、公开四语分类和安全链接；不批量改曲目权限，VIP 仍逐次走 /audio。后续 M5-01B 批量上传依赖此模型，四角色预览和主推收尾继续待办。
