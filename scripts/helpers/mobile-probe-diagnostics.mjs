...
const phases=new Set(['startup','seed_account','seed_password','seed_password_hash','seed_password_write','authorize_get','authorize_body','authorize_post','token_exchange','token_body','evidence_session','evidence_operations','refresh','refresh_body','request','response','held','shutdown']);
