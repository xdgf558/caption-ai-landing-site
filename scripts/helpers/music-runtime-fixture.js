...
export async function seedMusicRuntimeFixture(db, { audio, preview, accessMode = 'vip', freeUntil = null }) {
  ...
  await insert(db, 'music_track_revisions', { id: revisionId, track_id: id, revision_no: 1,
    audio_asset_id: audio.id, preview_asset_id: preview.id, access_mode: accessMode, free_until: freeUntil, created_at: now - 2000,
