...
export const serialsCopy = {
  ...
  'zh-Hant': {
    ...
    description: 'Station Cat 的長篇連載小說入口。目前主連載為《离线未来》，保留作品介紹、章節順序與閱讀入口。',
    eyebrow: '連載小說',
    heroTitle: '《离线未来》正在連載。',
    heroDescription: '1999 年，一台離線舊電腦裡的 AI 重新醒來。這裡是 Station Cat 長篇小說的固定入口，會保留作品說明、章節順序和更新狀態。',
    heroNote: '全書免費閱讀；第 1–9 章可直接閱讀，第 10 章起註冊或登入會員後即可繼續。',
    heroPrimary: '開始閱讀',
    heroSecondary: '查看章節',
    libraryLabel: '會員中心',
