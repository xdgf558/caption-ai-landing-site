...
import {MobileError,validID} from './security.js';
...
function tuple(value){
 ...
 if(keys(value,['trackId','favorite','version','updatedAt'])&&validID(value.trackId)&&typeof value.favorite==='boolean'&&integer(value.version)&&typeof value.updatedAt==='string'&&Number.isFinite(Date.parse(value.updatedAt)))return ['r1','favorite',value.trackId,value.favorite,value.version,value.updatedAt];
