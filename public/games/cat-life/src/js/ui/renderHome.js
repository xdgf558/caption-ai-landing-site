(function (game) {
  ...
  function renderHome(state) {
    ...
    var stageReaction = stageCat ? game.utils.catArt.getCatReaction(stageCat) : "";
    var stageReactionCue = stageCat ? game.utils.catArt.getCatReactionCue(stageCat) : "";
    ...
    return (
      ...
      (stageCat ? '<div class="cat-stage-art ' + (stageReaction ? "has-reaction" : "") + '" data-cat-reaction="' +
        format.escapeHtml(stageReaction) + '"><img src="' + game.utils.catArt.getCatStageUrl(stageCat) + '" alt="' +
        format.escapeHtml(getText(stageCat, "name")) + '" width="420" height="420" />' +
        (stageReactionCue ? '<span class="cat-reaction-cue" aria-hidden="true">' + stageReactionCue + '</span>' : '') +
        '<div class="cat-stage-name"><strong>' +
